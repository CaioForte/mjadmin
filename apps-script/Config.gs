...
const HEADERS = {
  ...
  Vendas: ['id','num','date','clientId','clientName','seller','subtotal','discount','total','payment','status','sourceQuoteId','obs','createdAt','cancelledAt','updatedAt','json','installments','firstDueDate','receiptFileId','receiptFileName','receiptUrl','receiptUploadedAt'],
  ...
  Financeiro: ['id','type','source','sourceId','description','category','date','dueDate','value','payment','status','notes','createdAt','paidAt','updatedAt','json','installmentNumber','installmentTotal','installmentGroupId'],
  Despesas: ['id','date','dueDate','status','value','description','category','payment','supplier','notes','createdAt','updatedAt','json'],
  Compras: ['id','num','date','supplierId','supplierName','subtotal','discount','freight','total','payment','financeStatus','generateFinance','updateCost','dueDate','notes','status','createdAt','cancelledAt','updatedAt','json','installments','receiptFileId','receiptFileName','receiptUrl','receiptUploadedAt'],
