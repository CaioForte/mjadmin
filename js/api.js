/* =====================================================
   MJ ADMIN V11.17 - GOOGLE SHEETS + APPS SCRIPT
...
(() => {
  ...
  async function bootstrap() {
    ...
    try {
      ...
      window.MJAppLoader?.set?.('loading','Recebendo cadastros, vendas, compras e financeiro...',52);
  ...
  window.MJCloud = {
    ...
    sendQuoteEmail: id => request('enviarOrcamentoEmail', { id }, 30000),
    ...
    finalizePurchase: compra => request('finalizarCompra', { compra }, 30000),
    cancelPurchase: id => request('cancelarCompra', { id }, 30000)
  };
})();
