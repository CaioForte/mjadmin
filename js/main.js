...
window.toast=toast;
const defaultQuotes=[
 {id:'q7',num:'ORC-0007',date:'2026-09-09',data:'09/09/2026',clientId:'',cliente:'Empresa X',items:[{id:'qi71',productId:'',name:'Envelopamento parcial',qty:1,unitPrice:1250}],discount:0,subtotal:1250,total:1250,valor:'R$ 1.250,00',validity:'2026-09-16',validade:'16/09/2026',status:'Pendente',paymentTerms:'50% de entrada e saldo na entrega',obs:'Proposta de envelopamento conforme alinhado com o cliente.'},
 {id:'q6',num:'ORC-0006',date:'2026-09-08',data:'08/09/2026',clientId:'',cliente:'João Silva',items:[{id:'qi61',productId:'',name:'Adesivo personalizado',qty:1,unitPrice:680}],discount:0,subtotal:680,total:680,valor:'R$ 680,00',validity:'2026-09-15',validade:'15/09/2026',status:'Aprovado',paymentTerms:'PIX',obs:''},
 {id:'q5',num:'ORC-0005',date:'2026-09-05',data:'05/09/2026',clientId:'',cliente:'Loja Central',items:[{id:'qi51',productId:'',name:'Comunicação visual',qty:1,unitPrice:2340}],discount:0,subtotal:2340,total:2340,valor:'R$ 2.340,00',validity:'2026-09-12',validade:'12/09/2026',status:'Convertido',paymentTerms:'A combinar',obs:''},
 {id:'q4',num:'ORC-0004',date:'2026-09-01',data:'01/09/2026',clientId:'',cliente:'Maria Souza',items:[{id:'qi41',productId:'',name:'Serviço de aplicação',qty:1,unitPrice:420}],discount:0,subtotal:420,total:420,valor:'R$ 420,00',validity:'2026-09-08',validade:'08/09/2026',status:'Expirado',paymentTerms:'PIX',obs:''}
];
...
const defaultProducts=[
  {id:'p1',code:'0001',name:'Adesivo Preto Fosco',category:'Adesivos',description:'Adesivo para envelopamento e acabamento fosco.',unit:'M',cost:45,price:85,stock:2,minStock:10,supplier:'Fornecedor A',status:'Ativo'},
  {id:'p2',code:'0002',name:'Película Solar',category:'Películas',description:'Película automotiva para controle solar.',unit:'M',cost:58,price:110,stock:3,minStock:8,supplier:'Fornecedor B',status:'Ativo'},
  {id:'p3',code:'0003',name:'Adesivo Branco',category:'Adesivos',description:'Adesivo branco para impressão e recorte.',unit:'M',cost:32,price:65,stock:5,minStock:10,supplier:'Fornecedor A',status:'Ativo'},
  {id:'p4',code:'0004',name:'Serviço de Aplicação',category:'Serviços',description:'Serviço de aplicação de adesivo/envelopamento.',unit:'SV',cost:0,price:180,stock:0,minStock:0,supplier:'',status:'Ativo'}
];
...
const defaultClients=[
  {id:'c1',type:'PF',document:'123.456.789-09',name:'João Silva',tradeName:'',phone:'(85) 99999-1001',whatsapp:'(85) 99999-1001',email:'joao@exemplo.com',zip:'61880-000',address:'Rua das Flores, 120',district:'Centro',city:'Itaitinga',state:'CE',status:'Ativo',createdAt:'2026-09-01',notes:'Cliente recorrente para serviços automotivos.'},
  {id:'c2',type:'PJ',document:'12.345.678/0001-95',name:'Empresa X Comunicação Visual LTDA',tradeName:'Empresa X',phone:'(85) 99999-2002',whatsapp:'(85) 99999-2002',email:'contato@empresax.com',zip:'60822-000',address:'Av. Principal, 850',district:'Messejana',city:'Fortaleza',state:'CE',status:'Ativo',createdAt:'2026-09-02',notes:'Solicita orçamento antes de autorizar os serviços.'},
  {id:'c3',type:'PF',document:'987.654.321-00',name:'Maria Souza',tradeName:'',phone:'(85) 98888-3003',whatsapp:'(85) 98888-3003',email:'maria@exemplo.com',zip:'61880-000',address:'',district:'',city:'Itaitinga',state:'CE',status:'Ativo',createdAt:'2026-09-05',notes:''},
  {id:'c4',type:'PJ',document:'45.723.174/0001-10',name:'Loja Central LTDA',tradeName:'Loja Central',phone:'(85) 3333-4400',whatsapp:'(85) 99990-4400',email:'financeiro@lojacentral.com.br',zip:'60000-000',address:'Rua do Comércio, 45',district:'Centro',city:'Fortaleza',state:'CE',status:'Inativo',createdAt:'2026-08-20',notes:'Cadastro mantido apenas para histórico.'}
];
...
function closeSaleCancelSuccess(){const m=document.getElementById('saleCancelSuccessModal');if(m){m.classList.remove('show');m.setAttribute('aria-hidden','true');}}
